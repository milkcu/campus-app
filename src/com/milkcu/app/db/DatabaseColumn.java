...
public abstract class DatabaseColumn implements BaseColumns {
	 ...
	 */
	public static final String AUTHORITY = "com.milkcu.app.provider";
	/**
	 * The database's name
	 */
	...
	public static final String[] SUBCLASSES = new String[] {
			"com.milkcu.app.db.BlogColumn", "com.milkcu.app.db.NewsColumn",
			"com.milkcu.app.db.DetailColumn", "com.milkcu.app.db.ImageCacheColumn",
			"com.milkcu.app.db.RequestCacheColumn" };
